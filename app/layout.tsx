...
export const metadata: Metadata = {
    title: 'Portfolio - Firdose Ara',
    description: 'AI and Data Science professional portfolio of Firdose Ara. Specialized in machine learning, computer vision, and intelligent systems development.',
};
