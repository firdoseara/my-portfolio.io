    ...
    return (
        ...
        >
            ...
            <div className="flex gap-2 md:gap-5">
                ...
                <div className="">
                    <h4 className="text-2xl xs:text-4xl flex gap-4 font-anton transition-all duration-700 bg-gradient-to-r from-primary to-foreground from-[50%] to-[50%] bg-[length:200%] bg-right bg-clip-text text-transparent group-hover:bg-left">
                        {project.title}
